    ...
    <Dropdown title="解决方案" isScrolled={isScrolled}>
      <div className="flex h-[308px]">
        ...
        <div className="flex-1 bg-white relative">
          ...
          <div className="absolute right-[32px] top-[21px] w-[90px] h-[90px] bg-[#D9D9D9]"></div>
          <div className="absolute right-[32px] top-[159px] w-[90px] h-[90px] bg-[#D9D9D9]"></div>

          {/* Image labels */}
          <div className="absolute right-[49px] top-[114px] text-[#666] font-inter text-[14px] font-medium leading-6 tracking-[-0.14px]">
            甬城低碳
          </div>
          <div className="absolute right-[25px] top-[257px] text-[#666] font-inter text-[14px] font-medium leading-6 tracking-[-0.14px]">
            个人碳足迹计算
          </div>
        </div>
      </div>
