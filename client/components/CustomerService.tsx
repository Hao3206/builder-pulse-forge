  ...
  return (
    <>
      ...
      <div className="fixed right-6 top-1/2 transform -translate-y-1/2 z-50">
        <button
          onClick={togglePopup}
          className="bg-[#058A65] hover:bg-[#046B52] transition-colors duration-300 rounded-full w-[50px] h-[140px] flex flex-col items-center justify-center text-white shadow-lg"
        >
          {/* Headset Icon */}
          <div className="w-6 h-6 mb-2">
            ...
            <div className="absolute top-2 left-3.5 w-0.5 h-0.5 bg-white rounded-full"></div>
          </div>
                ...
                <div className="flex items-center justify-between p-4 hover:bg-gray-50 transition-colors cursor-pointer">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-[#058A65] font-medium">
                        8888-888-88
                      </div>
                    </div>
                  </div>
