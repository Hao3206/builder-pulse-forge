...
export default function About() {
  ...
  return (
    <div className="flex w-[1440px] flex-col items-start bg-white min-h-screen">
      {/* Sticky Header */}
      <div
      ...
      {/* Hero Section */}
      <div className="flex w-[1440px] pb-0.5 flex-col justify-center items-center bg-[#F8F9FB] relative">
        {/* Hero Content */}
        <div className="flex w-[1440px] h-[286px] flex-col items-center gap-6 relative pt-[102px]">
          <h1 className="w-[1440px] text-white text-center font-inter text-[44px] font-bold leading-[60px] tracking-[-0.88px] relative">
            关于浙东环境能源交易所
          </h1>
          <p className="w-[1440px] text-white/80 text-center font-inter text-lg font-normal leading-[26px] tracking-[-0.1px] relative -mt-[86px]">
        ...
        <img
          ...
          className="w-[1484px] h-[1036px] relative -right-[29px] -bottom-[525px]"
        />
      </div>

      {/* Company Introduction Section */}
      <div className="w-[1442px] h-[563px] relative">
        <div className="w-[1442px] h-[563px] absolute left-0 top-0">
          <div className="w-[1440px] h-[563px] bg-[rgba(5,138,101,0.05)] absolute left-0 top-0" />

          {/* Mission Icon */}
          <div className="flex w-[60px] h-[60px] p-2 justify-center items-center rounded-full border border-[#EBF8F6] bg-[#058A65] absolute left-[112px] top-[319px]">
          ...
          {/* Vision Icon */}
          <div className="flex w-[60px] h-[60px] p-2 justify-center items-center rounded-full border border-[#EBF8F6] bg-[#058A65] absolute left-[492px] top-[319px]">
            <svg className="w-[30px] h-[30px]" viewBox="0 0 30 30" fill="none">
              <path
              ...
              />
              <path
                d="M12.8105 15.0011C12.8105 16.1911 13.7923 17.1554 15.0021 17.1554C16.2125 17.1554 17.1936 16.1911 17.1936 15.0011C17.1936 13.8111 16.2119 12.8467 15.0021 12.8467C13.7923 12.8467 12.8105 13.8111 12.8105 15.0011Z"
                fill="white"
              />
            </svg>
          </div>
          ...
          {/* Mission */}
          <div className="text-[#333] text-center font-inter text-2xl font-semibold leading-7 tracking-[-0.24px] absolute left-[112px] top-[401px] w-12 h-7">
            使命
          </div>

          {/* Vision */}
          <div className="text-[#333] text-center font-inter text-2xl font-semibold leading-7 tracking-[-0.24px] absolute left-[498px] top-[401px] w-12 h-7">
            愿景
          </div>

          {/* Mission Description */}
          <div className="w-[310px] text-[#666] font-inter text-base font-normal leading-6 absolute left-[112px] top-[441px] h-12">
            推动全球双碳目标的实现，为企业和政府提供专���的碳管理解决方案。
          </div>

          {/* Vision Description */}
          <div className="w-[310px] text-[#666] font-inter text-base font-normal leading-6 tracking-[-0.1px] absolute left-[492px] top-[441px] h-12">
            成为国内领先、国际一流的环境能源交易平台，助力实现可持续发展的低碳未来。
          </div>

          {/* Main Content Box */}
          <div className="flex w-[818px] flex-col items-start gap-3.5 border border-[#EBF8F6] absolute left-[112px] top-[121px] h-[124px]">
            ...
            <div className="w-[704px] h-[71px] text-[#666] font-inter text-base font-normal leading-6 tracking-[-0.1px]">
          ...
          {/* Decorative SVG */}
          <svg
            className="w-[584px] h-[395px] absolute left-[858px] top-[168px]"
            viewBox="0 0 586 396"
            fill="none"
          >
            <path
        ...
        <img
          ...
          className="w-[471px] h-[525px] absolute left-[969px] top-[38px]"
        />
      </div>

      {/* Culture & Values Section */}
      <div className="w-[1440px] h-[260px] bg-[#058A65] relative">
        {/* Divider Lines */}
        <svg
          className="w-0 h-[98px] absolute left-[346px] top-[94px]"
          viewBox="0 0 2 99"
          fill="none"
        >
        ...
        <svg
          className="w-0 h-[98px] absolute left-[614px] top-[94px]"
          viewBox="0 0 2 99"
          fill="none"
        >
          <path d="M1 0.785156V98.7852" stroke="white" strokeOpacity="0.5" />
        ...
        {/* Innovation */}
        <div className="flex w-[200px] h-[107px] py-5 flex-col items-center gap-3.5 absolute left-[112px] top-[77px]">
          <div className="text-white text-center font-inter text-2xl font-semibold leading-7 tracking-[-0.24px] w-full">
            创新
          </div>
          <div className="text-white/80 text-center font-inter text-sm font-normal leading-6 tracking-[-0.1px] w-full">
            始终站在行业前沿，不断探索和创新碳管理与绿色发展技术。
          </div>
        </div>

        {/* Collaboration */}
        <div className="flex w-[200px] h-[107px] py-5 flex-col items-center gap-3.5 absolute left-[380px] top-[77px]">
          <div className="text-white text-center font-inter text-2xl font-semibold leading-7 tracking-[-0.24px] w-full">
            协作
          </div>
          <div className="text-white/80 text-center font-inter text-sm font-normal leading-6 tracking-[-0.1px] w-full">
        ...
        {/* Responsibility */}
        <div className="flex w-[200px] h-[107px] py-5 flex-col items-center gap-3.5 absolute left-[648px] top-[77px]">
          <div className="text-white text-center font-inter text-2xl font-semibold leading-7 tracking-[-0.24px] w-full">
            责任
          </div>
          <div className="text-white/80 text-center font-inter text-sm font-normal leading-6 tracking-[-0.1px] w-full">
        ...
        {/* Right Side Header */}
        <div className="w-[283px] h-[33px] text-white font-inter text-[32px] font-bold leading-normal tracking-[-0.64px] absolute left-[970px] top-[83px]">
          我们的文化与价值观
        </div>
        <div className="w-[358px] h-[39px] text-white font-inter text-base font-normal leading-6 tracking-[-0.1px] absolute left-[970px] top-[138px]">
          浙东环境能源交易所秉持创新、协作、责任的企业文化，致力于为员工、客户与社会创造共同价值
        </div>
      </div>

      {/* Partnership Platforms */}
      <div className="flex w-[1440px] p-20 px-28 flex-col justify-center items-center gap-16 bg-white">
        ...
        <div className="flex flex-col items-start gap-[30px] w-full">
          <div className="flex justify-center items-center content-center gap-[30px] w-full flex-wrap rounded-[10px]">
            <div className="flex w-[592px] h-[188px] min-w-[280px] p-5 px-7 flex-col justify-center items-start gap-5 rounded-[10px] bg-[#F7F8FA]">
              <img
          ...
          <div className="flex justify-center items-center content-center gap-[30px] w-full flex-wrap rounded-[10px]">
            <div className="flex w-[592px] h-[188px] min-w-[280px] p-5 px-7 flex-col justify-center items-start gap-5 rounded-[0px] bg-[#F7F8FA]">
              <img
      ...
      <div className="flex p-20 flex-col items-center gap-16 w-full">
        ...
        <div className="flex items-start gap-7 rounded-[10px] relative">
          {honors.map((honor, index) => (
            ...
            >
              ...
              <div className="text-[#333] font-inter text-xl font-medium leading-[30px] tracking-[-0.2px]">
                {honor.title}
              </div>
            </div>
          ))}
      ...
      {/* Navigation Arrows */}
      <div className="w-[66px] h-[66px] relative left-[112px] top-[2269px]">
        <div className="w-[66px] h-[66px] rounded-full bg-black/30 absolute left-0 top-0" />
        <svg
          className="w-[19px] h-[9px] rotate-90 absolute left-[29px] top-[23px]"
          viewBox="0 0 11 21"
          fill="none"
        >
          <path
      ...
      <div className="w-[66px] h-[66px] relative left-[1262px] top-[2269px]">
        <div className="w-[66px] h-[66px] rounded-full bg-black/30 absolute left-0 top-0" />
        <svg
          className="w-[19px] h-[9px] -rotate-90 absolute left-[28px] top-[23px]"
          viewBox="0 0 11 21"
          fill="none"
        >
          <path
      ...
      {/* Our Services */}
      <div className="flex w-[1440px] p-20 px-28 flex-col justify-center items-center gap-16 bg-[rgba(5,138,101,0.05)]">
        <div className="flex max-w-[1280px] flex-col justify-center items-center gap-3 w-full">
          <div className="flex w-[800px] flex-col justify-center items-center gap-2">
            <div className="flex flex-col items-center gap-4 w-full">
              <h2 className="text-[#333] text-center font-inter text-[32px] font-bold leading-10 tracking-[-0.48px] w-full">
        ...
        <div className="flex flex-col items-start gap-10 w-full">
          <div className="flex flex-col items-start gap-[30px] w-full">
            ...
            <div className="flex items-start content-start gap-8 w-full flex-wrap">
              <div className="flex h-[230px] min-w-[320px] p-6 px-8 flex-col items-start gap-6 flex-1 rounded-xl bg-white shadow-[0px_1px_2px_0px_rgba(16,24,40,0.04)]">
      ...
      {/* Contact Section */}
      <div className="flex w-[1440px] p-20 px-28 justify-center items-start bg-white">
        <div className="flex items-start gap-16 flex-1">
          ...
          <div className="flex p-8 flex-col justify-end items-start flex-1 self-stretch rounded-[10px]">
            ...
            <img
              ...
              alt="Map Marker"
              className="flex items-start gap-2.5 relative -right-[174px] top-[57px] rounded-full"
            />

            {/* Contact Info Card */}
            <div className="flex p-4 px-5 items-start gap-6 w-full rounded-[10px] border border-[#E5E5E7] bg-white shadow-[0px_1px_2px_0px_rgba(16,24,40,0.04)] relative">
              <div className="flex flex-col items-start gap-1 flex-1">
                <div className="text-[#333] font-inter text-[15px] font-semibold leading-[22px] w-full">
                  公司地址
                </div>
                <div className="text-[#666] font-inter text-sm font-medium leading-5 tracking-[-0.1px] w-full">
                  地址文案文案文案文案
                </div>
              </div>
              <div className="flex flex-col items-start gap-[19px] flex-1">
                <div className="flex flex-col items-start gap-1 w-full">
                  <div className="text-[#333] font-inter text-[15px] font-semibold leading-[22px] tracking-[-0.1px] w-full">
                    电话
                  </div>
                  <div className="text-[#666] font-inter text-sm font-medium leading-5 tracking-[-0.1px] w-full">
                    021-888888888
          ...
          <div className="flex flex-col items-start gap-12 flex-1">
            ...
            <div className="flex flex-col items-start gap-6 w-full">
              ...
              <div className="flex h-[124px] flex-col items-start gap-2 w-full">
                <div className="flex p-3 px-4 items-start gap-2.5 flex-1 w-full rounded-md border border-[#E5E5E7] bg-[#F8F9FB]">
                  <div className="flex-1 text-[#999] font-inter text-[15px] font-medium leading-[22px]">
                    您的问题
                  </div>
                </div>
              </div>

              <div className="flex py-3 px-[18px] justify-center items-center gap-1.5 w-full rounded-full bg-[#058A65] shadow-[0px_1px_2px_0px_rgba(16,24,40,0.04)]">
                <div className="text-white font-inter text-[15px] font-semibold leading-[22px]">
                  立即咨询
                </div>
              </div>
            </div>
